...
class FavouriteDetails extends StatefulWidget {
  final indexPass;
  const FavouriteDetails({super.key, required this.indexPass});

  @override
  State<FavouriteDetails> createState() => _FavouriteDetailstate();
}

class _FavouriteDetailstate extends State<FavouriteDetails> {
  String? firstHalf;
  String? secondHalf;
  String? txt;
  ...
  Widget build(BuildContext context) {
    var image = widget.indexPass['posts']['images'];
    String txt = widget.indexPass['posts']['description'].toString();
    String others = widget.indexPass['posts']['others'].toString();
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        text(
                            ...
                            color: textwhite),
                        text(
                            title: "${widget.indexPass['posts']['area']} Sq.Ft",
                            fontsize: 14.0,
                            fontweight: FontWeight.bold,
                            color: orange),
                      ],
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          textIconFunColumn(
                              title:
                                  "${widget.indexPass['posts']['bedrooms']} Beds",
                          ...
                          textIconFunColumn(
                              title:
                                  "${widget.indexPass['posts']['bathrooms']} Bath",
                          ...
                          textIconFunColumn(
                              title:
                                  "${widget.indexPass['posts']['parking']} Parking",
                    ...
                    Column(
                      ...
                      children: [
                        textButton(
                          text1: "Posted By",
                          text2: widget.indexPass['posts']['user']['name']
                              .toString()
                              .toUpperCase(),
                          // buttonTitle: "Call",
                        ...
                        textButton(
                          text1: "Date: ",
                          text2: '/t ${widget.indexPass['created_at']}'
                              .substring(2, 13),
                          // buttonTitle: "Message",
